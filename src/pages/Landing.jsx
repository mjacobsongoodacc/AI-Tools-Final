...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-black font-sans">
      {/* Nav */}
      <nav className="border-b border-bone-15 px-6 py-4 sticky top-0 z-50 bg-black/95 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Link
              to="/dashboard"
              className="text-bone-70 hover:text-white text-sm font-medium px-3 py-1.5 rounded-lg hover:bg-bone-5 transition-colors"
            >
              Sign in
            </Link>
            <Link
      ...
      <section className="relative overflow-hidden px-6 pt-20 pb-24 sm:pt-28 sm:pb-32">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="lg:grid lg:grid-cols-[1.1fr_0.9fr] lg:gap-12 lg:items-center text-center lg:text-left">
            <div>
              <div className="inline-flex items-center gap-2 bg-accent/12 border border-accent/35 rounded-full px-4 py-1.5 mb-6">
                <LightningBoltIcon width={13} height={13} className="text-accent" />
                <span className="text-accent text-xs font-medium">AI-Powered · Citation-Backed · Auditable</span>
              </div>
              ...
              <p className="text-lg sm:text-xl text-bone-70 max-w-2xl mx-auto lg:mx-0 mb-10 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3">
                <Link
                  to="/dashboard"
                  className="w-full sm:w-auto flex items-center justify-center gap-2 bg-accent hover:bg-accent-hover text-white font-semibold px-6 py-3.5 rounded-xl transition-colors text-base"
                >
                  Get Started Free
                ...
                <Link
                  to="/dashboard"
                  className="w-full sm:w-auto flex items-center justify-center gap-2 border border-bone-15 hover:border-bone-25 text-bone-70 hover:text-white font-medium px-6 py-3.5 rounded-xl transition-colors text-base"
                >
                  Request Demo
                </Link>
              </div>

              <p className="text-bone-25 text-xs mt-4">Early access · Built with security in mind</p>
            </div>
      ...
      {/* Stats bar */}
      <section className="border-y border-bone-15 bg-ink-50 px-6 py-8">
        ...
        <section className="px-6 py-20 sm:py-24">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-14">
              ...
              <p className="text-bone-70 text-base max-w-xl mx-auto">
                Traditional due diligence is slow, inconsistent, and hard to trace. DiligenceAI is built to help with that.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-ink-50 border border-bone-15 rounded-2xl p-7">
                <div className="flex items-center gap-2.5 mb-5">
                  <div className="w-7 h-7 bg-accent/15 rounded-lg flex items-center justify-center">
                    <span className="text-accent text-xs font-bold">!</span>
                  </div>
                  <h3 className="text-white font-semibold">The Old Way</h3>
                </div>
                <ul className="space-y-3.5">
                  {problems.map((p) => (
                    <li key={p} className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full border border-accent/35 bg-accent/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-accent text-xs font-bold">✕</span>
                      </div>
                      <span className="text-bone-70 text-sm leading-relaxed">{p}</span>
                    </li>
                  ))}
                </ul>
              </div>

              <div className="bg-accent/5 border border-accent/35 rounded-2xl p-7 relative overflow-hidden">
                ...
                <div className="flex items-center gap-2.5 mb-5">
                  ...
                  <h3 className="text-white font-semibold">With DiligenceAI</h3>
                </div>
                <ul className="space-y-3.5">
                  {solutions.map((s) => (
                    <li key={s} className="flex items-start gap-3">
                      <CheckCircledIcon width={17} height={17} className="text-green-400 flex-shrink-0 mt-0.5" />
                      <span className="text-bone-70 text-sm leading-relaxed">{s}</span>
                    </li>
                  ))}
                </ul>
              </div>
        ...
        >
          <div className="max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true, margin: '-80px' }}
            >
              <motion.div variants={problemCardVariants} className="bg-ink-50 border border-bone-15 rounded-2xl p-7">
                <div className="flex items-center gap-2.5 mb-5">
                  <div className="w-7 h-7 bg-accent/15 rounded-lg flex items-center justify-center">
                    <span className="text-accent text-xs font-bold">!</span>
                  </div>
              ...
              <motion.div
                ...
                className="bg-accent/5 border border-accent/35 rounded-2xl p-7 relative overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-40 h-40 bg-accent/5 rounded-full blur-2xl" />
                <div className="flex items-center gap-2.5 mb-5">
                  <div className="w-7 h-7 bg-accent/20 rounded-lg flex items-center justify-center">
      ...
      {/* Features */}
      {reduce ? (
        <section className="px-6 py-20 sm:py-24 bg-ink-50/50">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-14">
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 tracking-tight">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {features.map(({ icon: Icon, title, description }) => (
                <TiltCard key={title}>
                  <div className="bg-black border border-bone-15 rounded-2xl p-6 hover:border-accent/35 transition-colors group h-full">
                    <div className="w-10 h-10 bg-accent/12 border border-accent/35 rounded-xl flex items-center justify-center mb-4 group-hover:bg-accent/15 transition-colors">
        ...
        <motion.section
          className="px-6 py-20 sm:py-24 bg-ink-50/50"
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: '-80px' }}
          transition={{ duration: 0.6, ease: 'easeOut' }}
      ...
      {reduce ? (
        <section className="px-6 py-20 sm:py-24">
          <div className="max-w-4xl mx-auto">
            <div className="bg-ink-50 border border-bone-15 rounded-2xl p-8 sm:p-12 text-center">
              <div className="w-12 h-12 bg-accent/12 border border-accent/35 rounded-2xl flex items-center justify-center mx-auto mb-5">
                <LockClosedIcon width={22} height={22} className="text-accent" />
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 tracking-tight">
                Built for institutional trust
              </h2>
              <p className="text-bone-70 text-base max-w-xl mx-auto mb-8 leading-relaxed">
                Your documents are not used to train any models. Built with venture, PE, and corporate development workflows in mind.
              </p>
              <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-bone-40">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <motion.div
              className="bg-ink-50 border border-bone-15 rounded-2xl p-8 sm:p-12 text-center"
      ...
      {/* CTA */}
      {reduce ? (
        <section className="relative overflow-hidden px-6 py-20 sm:py-24 border-t border-bone-15">
          <LissajousWeb />
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent z-[1]" />
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 tracking-tight">
              Ready to accelerate your diligence?
            </h2>
            <p className="text-bone-70 text-base mb-8">
              Built for investment teams who want a faster, more consistent first pass on every deal.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                to="/dashboard"
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-accent hover:bg-accent-hover text-white font-semibold px-7 py-3.5 rounded-xl transition-colors text-base"
              >
                Get Started Free
                <ArrowRightIcon width={17} height={17} />
              </Link>
              <Link
                to="/dashboard"
                className="w-full sm:w-auto text-bone-40 hover:text-bone-70 font-medium px-4 py-3.5 text-base transition-colors"
              >
        ...
        <motion.section
          className="relative overflow-hidden px-6 py-20 sm:py-24 border-t border-bone-15"
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: '-80px' }}
          transition={{ duration: 0.6, ease: 'easeOut' }}
      ...
      {/* Footer */}
      <footer className="border-t border-bone-15 px-6 py-8">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-accent rounded-md flex items-center justify-center">
              <CheckCircledIcon width={12} height={12} className="text-white" />
            </div>
            <span className="text-bone-40 text-sm">DiligenceAI</span>
          </div>
